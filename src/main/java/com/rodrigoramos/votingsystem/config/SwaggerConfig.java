...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.rodrigoramos.votingsystem.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API ...",
                "Esta API é utilizada para funcionários escolherem de forma democratica onde irão almoçar",
                "Versão 1.0",
                "",
                new Contact("Rodrigo Ramos", "", "rodrigo.ramos.pa@gmail.com"),
